...
const H = (e) => (typeof e == 'boolean' ? `${e}` : e === 0 ? '0' : e),
  ...
  Oe = (e, t) => (r) => {
    ...
    if ((t == null ? void 0 : t.variants) == null)
      return Q(e, r == null ? void 0 : r.class, r == null ? void 0 : r.className)
        ...
        t == null || (o = t.compoundVariants) === null || o === void 0
          ...
          : o.reduce((c, g) => {
              ...
              return Object.entries(w).every((x) => {
                let [f, d] = x
                return Array.isArray(d) ? d.includes({ ...n, ...s }[f]) : { ...n, ...s }[f] === d
              })
                ? [...c, h, m]
                : c
            }, [])
  ...
  re = (e, t) => {
    ...
    const n = e.join(U)
    return (a = t.validators.find(({ validator: s }) => s(n))) == null ? void 0 : a.classGroupId
  },
  Y = /^\[(.+)\]$/,
  ae = (e) => {
    if (Y.test(e)) {
      ...
      ? e.map(([r, o]) => {
          const l = o.map((n) =>
            typeof n == 'string'
              ? t + n
              : typeof n == 'object'
                ? Object.fromEntries(Object.entries(n).map(([a, s]) => [t + a, s]))
                : n
          )
          return [r, l]
        })
...
const u = (e) => {
  ...
  Le = () => {
    ...
    return {
      ...
      classGroups: {
        ...
        'max-w': [
          { 'max-w': [i, t, 'none', 'full', 'min', 'max', 'fit', 'prose', { screen: [A] }, A] },
        ],
        ...
        'bg-image': [
          { bg: ['none', { 'gradient-to': ['t', 'tr', 'r', 'br', 'b', 'bl', 'l', 'tl'] }, Ne] },
        ],
        'bg-color': [{ bg: [e] }],
  ...
  We = xe(Le)
export { Oe as a, le as c, We as t }
